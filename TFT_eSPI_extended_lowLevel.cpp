...
***************************************************************************************/
void TFT_eSPI_extended::myDataSend( uint16_t *data, int len, int minc)
{
    while(len)
    {
        int v;
 ...
 * @param c
 */
void              TFT_eSPI_extended::rawWrite8(uint8_t c)
{
    _spi.transfer(c);
}
/**
 ...
 * @param c
 */
void              TFT_eSPI_extended::rawWrite16(uint16_t c)
{
    _spi.transfer16(c);
}
// EOF
